...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('FOS\\CKEditorBundle\\Form\\Type\\CKEditorType' => function () {
    ...
    return ($this->privates['fos_user.change_password.form.type'] ?? $this->privates['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('App\\Application\\Sonata\\UserBundle\\Entity\\User'));
}, 'FOS\\UserBundle\\Form\\Type\\GroupFormType' => function () {
    return ($this->privates['fos_user.group.form.type'] ?? $this->privates['fos_user.group.form.type'] = new \FOS\UserBundle\Form\Type\GroupFormType('App\\Application\\Sonata\\UserBundle\\Entity\\Group'));
}, 'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => function () {
    return ($this->privates['fos_user.profile.form.type'] ?? $this->privates['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('App\\Application\\Sonata\\UserBundle\\Entity\\User'));
}, 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => function () {
    return ($this->privates['fos_user.registration.form.type'] ?? $this->privates['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('App\\Application\\Sonata\\UserBundle\\Entity\\User'));
}, 'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => function () {
    return ($this->privates['fos_user.resetting.form.type'] ?? $this->privates['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('App\\Application\\Sonata\\UserBundle\\Entity\\User'));
...
}, 'Sonata\\FormatterBundle\\Form\\Type\\FormatterType' => function () {
    return ($this->privates['sonata.formatter.form.type.selector'] ?? $this->load('getSonata_Formatter_Form_Type_SelectorService.php'));
}, 'Sonata\\FormatterBundle\\Form\\Type\\SimpleFormatterType' => function () {
    return ($this->privates['sonata.formatter.form.type.simple'] ?? $this->load('getSonata_Formatter_Form_Type_SimpleService.php'));
}, 'Sonata\\MediaBundle\\Form\\Type\\MediaType' => function () {
    return ($this->privates['sonata.media.form.type.media'] ?? $this->load('getSonata_Media_Form_Type_MediaService.php'));
}, 'Sonata\\UserBundle\\Form\\Type\\RolesMatrixType' => function () {
    return ($this->services['sonata.user.form.roles_matrix_type'] ?? $this->load('getSonata_User_Form_RolesMatrixTypeService.php'));
}, 'Sonata\\UserBundle\\Form\\Type\\SecurityRolesType' => function () {
    return ($this->services['sonata.user.form.type.security_roles'] ?? $this->load('getSonata_User_Form_Type_SecurityRolesService.php'));
}, 'Sonata\\UserBundle\\Form\\Type\\UserGenderListType' => function () {
    return ($this->privates['sonata.user.form.gender_list'] ?? $this->load('getSonata_User_Form_GenderListService.php'));
    ...
    yield 4 => ($this->services['sonata.admin.form.extension.field'] ?? $this->load('getSonata_Admin_Form_Extension_FieldService.php'));
    yield 5 => ($this->services['sonata.admin.form.extension.field.mopa'] ?? $this->services['sonata.admin.form.extension.field.mopa'] = new \Sonata\AdminBundle\Form\Extension\Field\Type\MopaCompatibilityTypeFieldExtension());
    ...
    yield 2 => ($this->privates['Fresh\DoctrineEnumBundle\Form\EnumTypeGuesser'] ?? $this->load('getEnumTypeGuesserService.php'));
