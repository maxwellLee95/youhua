...
// Returns the private 'App\Repository\CustomPageRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CustomPageRepository.php';

return $this->privates['App\Repository\CustomPageRepository'] = new \App\Repository\CustomPageRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
