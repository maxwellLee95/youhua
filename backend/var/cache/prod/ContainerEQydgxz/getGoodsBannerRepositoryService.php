...
// Returns the private 'App\Repository\GoodsBannerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GoodsBannerRepository.php';

return $this->privates['App\Repository\GoodsBannerRepository'] = new \App\Repository\GoodsBannerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
