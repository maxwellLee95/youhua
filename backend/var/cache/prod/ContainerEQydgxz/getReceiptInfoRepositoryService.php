...
// Returns the private 'App\Repository\ReceiptInfoRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ReceiptInfoRepository.php';

return $this->privates['App\Repository\ReceiptInfoRepository'] = new \App\Repository\ReceiptInfoRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
