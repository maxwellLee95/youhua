...
$d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), array(0 => ($this->targetDirs[3].'/src/Entity'), 1 => ($this->targetDirs[3].'/vendor/picoss/sonata-extra-admin-bundle/Entity')));

$e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Application/Sonata/MediaBundle/Resources/config/doctrine') => 'App\\Application\\Sonata\\MediaBundle\\Entity', ($this->targetDirs[3].'/vendor/sonata-project/media-bundle/src/Resources/config/doctrine') => 'Sonata\\MediaBundle\\Entity', ($this->targetDirs[3].'/src/Application/Sonata/UserBundle/Resources/config/doctrine') => 'App\\Application\\Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'/vendor/sonata-project/user-bundle/src/Resources/config/doctrine') => 'Sonata\\UserBundle\\Entity'));
$e->setGlobalBasename('mapping');

$c->addDriver($d, 'App\\Entity');
$c->addDriver($d, 'Picoss\\SonataExtraAdminBundle\\Entity');
$c->addDriver($e, 'App\\Application\\Sonata\\MediaBundle\\Entity');
$c->addDriver($e, 'Sonata\\MediaBundle\\Entity');
$c->addDriver($e, 'App\\Application\\Sonata\\UserBundle\\Entity');
$c->addDriver($e, 'Sonata\\UserBundle\\Entity');
...
$a->setEntityNamespaces(array('App' => 'App\\Entity', 'ApplicationSonataMediaBundle' => 'App\\Application\\Sonata\\MediaBundle\\Entity', 'SonataMediaBundle' => 'Sonata\\MediaBundle\\Entity', 'ApplicationSonataUserBundle' => 'App\\Application\\Sonata\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'PicossSonataExtraAdminBundle' => 'Picoss\\SonataExtraAdminBundle\\Entity'));
...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BannerRepository' => function () {
    return ($this->privates['App\Repository\BannerRepository'] ?? $this->load('getBannerRepositoryService.php'));
}, 'App\\Repository\\ClassifyGoodsRepository' => function () {
    return ($this->privates['App\Repository\ClassifyGoodsRepository'] ?? $this->load('getClassifyGoodsRepositoryService.php'));
}, 'App\\Repository\\ConsumerRepository' => function () {
    return ($this->privates['App\Repository\ConsumerRepository'] ?? $this->load('getConsumerRepositoryService.php'));
}, 'App\\Repository\\CustomPageRepository' => function () {
    return ($this->privates['App\Repository\CustomPageRepository'] ?? $this->load('getCustomPageRepositoryService.php'));
}, 'App\\Repository\\GoodsBannerRepository' => function () {
    return ($this->privates['App\Repository\GoodsBannerRepository'] ?? $this->load('getGoodsBannerRepositoryService.php'));
}, 'App\\Repository\\GoodsRepository' => function () {
    return ($this->privates['App\Repository\GoodsRepository'] ?? $this->load('getGoodsRepositoryService.php'));
}, 'App\\Repository\\MarketingRepository' => function () {
    return ($this->privates['App\Repository\MarketingRepository'] ?? $this->load('getMarketingRepositoryService.php'));
...
}, 'App\\Repository\\OrderBillRepository' => function () {
    return ($this->privates['App\Repository\OrderBillRepository'] ?? $this->load('getOrderBillRepositoryService.php'));
...
}, 'App\\Repository\\ReceiptInfoRepository' => function () {
    return ($this->privates['App\Repository\ReceiptInfoRepository'] ?? $this->load('getReceiptInfoRepositoryService.php'));
}, 'App\\Repository\\WechatRepository' => function () {
    return ($this->privates['App\Repository\WechatRepository'] ?? $this->load('getWechatRepositoryService.php'));
}))));
...
(new \Doctrine\Bundle\DoctrineBundle\ManagerConfigurator(array(0 => 'softdeleteable'), array()))->configure($instance);
