...
// Returns the public 'app.admin.marketing' service.
...
include_once $this->targetDirs[3].'/src/Admin/MarketingAdmin.php';
...
$this->factories['app.admin.marketing'] = function () {
    $instance = new \App\Admin\MarketingAdmin('app.admin.marketing', 'App\\Entity\\Marketing', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('MarketingAdmin');
    $instance->showMosaicButton(false);
    $instance->setTemplateRegistry(($this->services['app.admin.marketing.template_registry'] ?? $this->load('getApp_Admin_Marketing_TemplateRegistryService.php')));
...
return $this->factories['app.admin.marketing']();
