...
// Returns the private 'App\Repository\GoodsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/GoodsRepository.php';

return $this->privates['App\Repository\GoodsRepository'] = new \App\Repository\GoodsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
