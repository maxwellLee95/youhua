...
// Returns the public 'app.admin.goods' service.
...
include_once $this->targetDirs[3].'/src/Admin/GoodsAdmin.php';
...
$this->factories['app.admin.goods'] = function () {
    $instance = new \App\Admin\GoodsAdmin('app.admin.goods', 'App\\Entity\\Goods', 'Sonata\\AdminBundle\\Controller\\CRUDController');

    $instance->setUploadableListener(($this->privates['rip.listener.uploadable'] ?? $this->load('getRip_Listener_UploadableService.php')));
    ...
    $instance->setLabel('GoodsAdmin');
    $instance->showMosaicButton(false);
    $instance->setTemplateRegistry(($this->services['app.admin.goods.template_registry'] ?? $this->load('getApp_Admin_Goods_TemplateRegistryService.php')));
...
return $this->factories['app.admin.goods']();
