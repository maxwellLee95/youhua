...
// Returns the public 'app.admin.classify_goods' service.
...
include_once $this->targetDirs[3].'/src/Admin/ClassifyGoodsAdmin.php';
...
$this->factories['app.admin.classify_goods'] = function () {
    $instance = new \App\Admin\ClassifyGoodsAdmin('app.admin.classify_goods', 'App\\Entity\\ClassifyGoods', 'PicossSonataExtraAdminBundle:ExtraAdmin');
    ...
    $instance->setLabel('ClassifyGoodsAdmin');
    $instance->showMosaicButton(false);
    $instance->setTemplateRegistry(($this->services['app.admin.classify_goods.template_registry'] ?? $this->load('getApp_Admin_ClassifyGoods_TemplateRegistryService.php')));
...
return $this->factories['app.admin.classify_goods']();
