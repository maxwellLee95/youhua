 ...
 */
class Wechat extends \App\Entity\Wechat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Wechat' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Wechat' . "\0" . 'openId', '' . "\0" . 'App\\Entity\\Wechat' . "\0" . 'consumer'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Wechat $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setOpenId(string $openId): \App\Entity\Wechat
    {
     ...
     * {@inheritDoc}
     */
    public function setConsumer(\App\Entity\Consumer $consumer): \App\Entity\Wechat
    {
