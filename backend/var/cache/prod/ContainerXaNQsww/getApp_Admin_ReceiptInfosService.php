...
// Returns the public 'app.admin.receipt_infos' service.
...
$this->factories['app.admin.receipt_infos'] = function () {
    $instance = new \App\Admin\ReceiptInfosAdmin('app.admin.receipt_infos', 'App\\Entity\\ReceiptInfo', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('ReceiptInfosAdmin');
    $instance->showMosaicButton(false);
    $instance->setTemplateRegistry(($this->services['app.admin.receipt_infos.template_registry'] ?? $this->load('getApp_Admin_ReceiptInfos_TemplateRegistryService.php')));
...
return $this->factories['app.admin.receipt_infos']();
