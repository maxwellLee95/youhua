...
// Returns the public 'sonata.media.admin.gallery' service.
...
$this->factories['sonata.media.admin.gallery'] = function () {
    $instance = new \Sonata\MediaBundle\Admin\GalleryAdmin('sonata.media.admin.gallery', 'App\\Application\\Sonata\\MediaBundle\\Entity\\Gallery', 'SonataMediaBundle:GalleryAdmin', ($this->services['sonata.media.pool'] ?? $this->getSonata_Media_PoolService()));
    ...
    $instance->setTemplateRegistry(($this->services['sonata.media.admin.gallery.template_registry'] ?? $this->load('getSonata_Media_Admin_Gallery_TemplateRegistryService.php')));
...
return $this->factories['sonata.media.admin.gallery']();
