...
// Returns the public 'app.admin.order_bill' service.
...
$this->factories['app.admin.order_bill'] = function () {
    $instance = new \App\Admin\OrderBillAdmin('app.admin.order_bill', 'App\\Entity\\OrderBill', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('OrderBillAdmin');
    $instance->showMosaicButton(false);
    $instance->setTemplateRegistry(($this->services['app.admin.order_bill.template_registry'] ?? $this->load('getApp_Admin_OrderBill_TemplateRegistryService.php')));
...
return $this->factories['app.admin.order_bill']();
