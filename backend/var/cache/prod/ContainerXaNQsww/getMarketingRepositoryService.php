...
// Returns the private 'App\Repository\MarketingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/MarketingRepository.php';

return $this->privates['App\Repository\MarketingRepository'] = new \App\Repository\MarketingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
