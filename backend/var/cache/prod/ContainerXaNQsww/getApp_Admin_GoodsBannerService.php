...
// Returns the public 'app.admin.goods_banner' service.
...
include_once $this->targetDirs[3].'/src/Admin/GoodsBannerAdmin.php';
...
$this->factories['app.admin.goods_banner'] = function () {
    $instance = new \App\Admin\GoodsBannerAdmin('app.admin.goods_banner', 'App\\Entity\\GoodsBanner', 'Sonata\\AdminBundle\\Controller\\CRUDController');
    ...
    $instance->setLabel('GoodsBanner');
    $instance->showMosaicButton(false);
    $instance->setTemplateRegistry(($this->services['app.admin.goods_banner.template_registry'] ?? $this->load('getApp_Admin_GoodsBanner_TemplateRegistryService.php')));
...
return $this->factories['app.admin.goods_banner']();
