...
// Returns the private 'App\Repository\ConsumerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ConsumerRepository.php';

return $this->privates['App\Repository\ConsumerRepository'] = new \App\Repository\ConsumerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
