...
// Returns the public 'sonata.media.admin.gallery_has_media' service.
...
$this->factories['sonata.media.admin.gallery_has_media'] = function () {
    $instance = new \Sonata\MediaBundle\Admin\GalleryHasMediaAdmin('sonata.media.admin.gallery_has_media', 'App\\Application\\Sonata\\MediaBundle\\Entity\\GalleryHasMedia', 'SonataAdminBundle:CRUD');
    ...
    $instance->setTemplateRegistry(($this->services['sonata.media.admin.gallery_has_media.template_registry'] ?? $this->load('getSonata_Media_Admin_GalleryHasMedia_TemplateRegistryService.php')));
...
return $this->factories['sonata.media.admin.gallery_has_media']();
