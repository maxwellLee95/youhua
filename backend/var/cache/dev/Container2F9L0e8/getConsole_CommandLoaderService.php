...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Symfony\\Bundle\\AclBundle\\Command\\InitAclCommand' => function (): \Symfony\Bundle\AclBundle\Command\InitAclCommand {
    return ($this->privates['Symfony\Bundle\AclBundle\Command\InitAclCommand'] ?? $this->load('getInitAclCommandService.php'));
}, 'Symfony\\Bundle\\AclBundle\\Command\\SetAclCommand' => function (): \Symfony\Bundle\AclBundle\Command\SetAclCommand {
    return ($this->privates['Symfony\Bundle\AclBundle\Command\SetAclCommand'] ?? $this->load('getSetAclCommandService.php'));
