...
// Returns the private 'App\Repository\OrderBillRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/OrderBillRepository.php';

return $this->privates['App\Repository\OrderBillRepository'] = new \App\Repository\OrderBillRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
