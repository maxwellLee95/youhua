...
// Returns the private 'App\Repository\WechatRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WechatRepository.php';

return $this->privates['App\Repository\WechatRepository'] = new \App\Repository\WechatRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
