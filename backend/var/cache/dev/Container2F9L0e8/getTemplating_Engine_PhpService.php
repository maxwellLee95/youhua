...
$this->privates['templating.engine.php'] = $instance = new \Symfony\Bundle\FrameworkBundle\Templating\TimedPhpEngine(($this->privates['templating.name_parser'] ?? $this->privates['templating.name_parser'] = new \Symfony\Bundle\FrameworkBundle\Templating\TemplateNameParser(($this->services['kernel'] ?? $this->get('kernel', 1)))), new \Symfony\Component\DependencyInjection\ServiceLocator(array('fos_ck_editor.templating.helper' => function () {
    ...
    return ($this->privates['jms_serializer.templating.helper.serializer'] ?? $this->load('getJmsSerializer_Templating_Helper_SerializerService.php'));
}, 'sonata.block.templating.helper' => function () {
    return ($this->privates['sonata.block.templating.helper'] ?? $this->getSonata_Block_Templating_HelperService());
...
}, 'templating.helper.markdown' => function () {
    return ($this->privates['templating.helper.markdown'] ?? $this->load('getTemplating_Helper_MarkdownService.php'));
