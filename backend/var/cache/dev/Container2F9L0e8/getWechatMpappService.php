...
return $this->services['App\Controller\WechatMpapp'] = new \App\Controller\WechatMpapp($this->parameters['rip.miniapp'], new \App\DependencyInjection\WechatPay($this->parameters['rip.payment'], $a, $b), $a, $b);
