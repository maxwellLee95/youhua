...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), array(0 => ($this->targetDirs[3].'/src/Entity'), 1 => ($this->targetDirs[3].'/vendor/picoss/sonata-extra-admin-bundle/Entity')));

$d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/Application/Sonata/MediaBundle/Resources/config/doctrine') => 'App\\Application\\Sonata\\MediaBundle\\Entity', ($this->targetDirs[3].'/vendor/sonata-project/media-bundle/src/Resources/config/doctrine') => 'Sonata\\MediaBundle\\Entity', ($this->targetDirs[3].'/src/Application/Sonata/UserBundle/Resources/config/doctrine') => 'App\\Application\\Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'/vendor/sonata-project/user-bundle/src/Resources/config/doctrine') => 'Sonata\\UserBundle\\Entity'));
$d->setGlobalBasename('mapping');

$b->addDriver($c, 'App\\Entity');
$b->addDriver($c, 'Picoss\\SonataExtraAdminBundle\\Entity');
$b->addDriver($d, 'App\\Application\\Sonata\\MediaBundle\\Entity');
$b->addDriver($d, 'Sonata\\MediaBundle\\Entity');
