<template>
  <div class="wrap">
    <div class="card">
      ...
      <div class="price">
        <text class='presentPrice'>
          {{member.presentPrice}}元
        </text>
        <text class='originalPrice'>
          {{member.originalPrice}}元
        </text>
      </div>
      <div class='subtitle'>自购买当日起90天内免费更换油画</div>
      <image class="image_frame" :src="['http://www.nowhoarts.com/'+member.image]"  mode="aspectFill"/>
    </div>
    <div class="just justPresentPrice">
      <text class="presentPrice">原价</text>
